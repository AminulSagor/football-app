    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          for (int i = 0; i < knockout.topRoundOne.length && i < topRoundOnePositions.length; i++)
            Positioned(
          ...
          for (int i = 0; i < knockout.topRoundTwo.length && i < topRoundTwoPositions.length; i++)
            Positioned(
          ...
          for (int i = 0; i < knockout.bottomRoundTwo.length && i < bottomRoundTwoPositions.length; i++)
            Positioned(
          ...
          for (int i = 0; i < knockout.bottomRoundOne.length && i < bottomRoundOnePositions.length; i++)
            Positioned(
...
class _RoundOneCard extends StatelessWidget {
  final MatchDetailsKnockoutNodeUiModel node;
  final double width;
  final double height;
...
class _CenterMatchCard extends StatelessWidget {
  final MatchDetailsKnockoutCenterUiModel item;
  final double width;
  final double height;
  final bool isFinal;
